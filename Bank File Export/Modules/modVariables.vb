Public Module modVariables
    ...
    Public Const mnu_Pay_ERBF As String = "mnu_Pay_ERBF"
    Public Const frm_Pay_ERBF As String = "frm_ImpWiPay_ERBF"
    Public Const xml_Pay_ERBF As String = "frm_Pay_ERBF.xml"
